...
# Using BRIQS 
An example of using BRIQS to image a phantom in 3D and obtain metric scores for two conditions:

```insert test code here later``` -- add in c1,3 and c2,3 in ONE run -- as a subplot probably
